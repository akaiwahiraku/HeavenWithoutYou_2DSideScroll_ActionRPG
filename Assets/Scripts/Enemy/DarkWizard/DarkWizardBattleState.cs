...
public class DarkWizardBattleState : EnemyState
{
    private Transform player;
    private Enemy_DarkWizard enemy;
    private int moveDir;
    public DarkWizardBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_DarkWizard _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
